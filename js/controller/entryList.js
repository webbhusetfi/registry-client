...
.controller('entryList', function($scope, $window, $route, $routeParams, $http, $location, $log, $uibModal, $filter, $timeout, globalParams, dialogHandler, dbHandler, PDFKit, FileSaver, Blob) {
